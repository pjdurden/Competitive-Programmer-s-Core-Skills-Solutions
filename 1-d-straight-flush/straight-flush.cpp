...
bool bruteforce(){
    return cards.find("11111")!=std::string::npos;
}
bool process(){
    if((str[1]==str[4])&&(str[4]==str[7])&&(str[7]==str[10])){
        for(int i=0;i<13;i+=3){
            if(str[i]<58&&str[i]>49)   cards[str[i]-48]='1';
            else if(str[i]=='A')     { cards[1]='1'; cards[14]='1';}
            else if(str[i]=='T')       cards[10]='1';
            else if(str[i]=='J')       cards[11]='1';
            else if(str[i]=='Q')       cards[12]='1';
            else if(str[i]=='K')       cards[13]='1';
        }
        //cout<<cards<<"\n";
        return bruteforce();
    }
